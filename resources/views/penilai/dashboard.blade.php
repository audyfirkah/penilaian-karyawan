...
<div class="container mx-auto px-4 py-6">
    <h1 class="text-3xl font-bold mb-6 text-gray-800">Dashboard Penilai</h1>

    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div class="bg-white p-4 rounded-lg shadow-md">
            <h2 class="text-xl font-semibold text-gray-700">Kategori Penilaian</h2>
            <p class="text-2xl text-orange-600 mt-2">{{ $jumlahKategori }}</p>
        </div>
        <div class="bg-white p-4 rounded-lg shadow-md">

...
<div class="bg-white p-6 rounded-lg shadow-md">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
        ...
        <!-- Add Kategori Button -->
        <a href="{{ route('penilai.kategori-penilaian.create') }}" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600 transition flex items-center text-center">
            ...
            <tbody class="divide-y divide-gray-200" id="kategoriTableBody">
                ...
                <tr class="kategori-row">
                    ...
                    <td class="px-6 py-4 text-sm space-x-2 flex items-center gap-2">
                        ...
                        <form action="{{ route('penilai.kategori-penilaian.destroy', $kategori->id_kategori) }}" method="POST" class="inline delete-form">
                            @csrf
                            @method('DELETE')

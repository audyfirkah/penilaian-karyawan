                    ...
                    <tr>
                        ...
                        <td class="px-4 py-2 text-sm">
                            <div class="mt-2 flex gap-1">
                                <a href="{{ route('kepala.penilaian.create', $jurnal->id_jurnal) }}" class="text-sm bg-green-100 hover:bg-green-200 text-green-600 px-2 py-1 rounded">Approve</a>
...
<script>
    ...
    function openRevisiModal(jurnalId) {
        ...
        document.getElementById('revisiForm').action = `/kepala/penilaian/${jurnalId}/revisi`;

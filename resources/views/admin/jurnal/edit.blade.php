...
<div class="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow-md">
    ...
    <form action="{{ route('admin.jurnal.update', $jurnal->id_jurnal) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="flex items-center justify-between">
            <a href="{{ route('admin.jurnal.show', $jurnal->id_jurnal) }}') }}" class="text-gray-600 hover:underline"><i class="fas fa-arrow-left"></i> Kembali</a>

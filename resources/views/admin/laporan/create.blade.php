...
<div class="bg-white p-6 rounded-lg shadow-md max-w-2xl mx-auto">
    ...
    <form action="{{ route('admin.laporan.store', $karyawan->id_karyawan) }}" method="POST" class="space-y-5">
        @csrf
        ...
        <div class="flex justify-between items-center">
            <a href="{{ route('admin.laporan.index') }}" class="text-gray-600 hover:underline">
